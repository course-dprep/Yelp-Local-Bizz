...
"Here we create the final data set. We join our previously joined review and user data set with the business data set. This allows us to obtain all the information necessary about the businesses that our sample users have written reviews on. 
Since both the business data set and the user data set have the columns 'stars' and 'reviews_count', we add a suffix to these columns to indicate the data sets' origin."
